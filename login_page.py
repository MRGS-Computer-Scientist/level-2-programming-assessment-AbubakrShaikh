...
with open("list_data.txt", "r") as user_file:
    # Read each line and convert it back to the original data type
...
class LoginPage:
    def __init__(self, master):
        ...
        self.login_button.grid(row=5, column=0, padx=50, pady=125)
        ...
        self.create_button.grid(row=5, column=1, padx=50, pady=125)
        ...
        self.exit_button.grid(row=6, column=0,padx=50, pady=125, columnspan=2)

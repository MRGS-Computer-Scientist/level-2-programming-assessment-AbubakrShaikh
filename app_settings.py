...
def error_function():  # Pass intro_frame as an argument
    ...
    error_window.geometry("230x70")
    error_window.configure(bg=bg_color)
    error_window.title("Error")
    error_message = Label(error_window, bg=bg_color, text="Please enter a valid username or password\n from 1 - 16 alphanumerical characters") # Tells the user to enter a vaild entry
